    ...
    if not match:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                os.system(clear_command)
                print("")
                print(colorama.Fore.YELLOW + f" Vanity URL Code: " + colorama.Fore.LIGHTWHITE_EX + str(data['guild'].get('vanity_url_code', 'None')))
                print(colorama.Fore.YELLOW + f" Premium Subscription Count (Boosts): " + colorama.Fore.LIGHTWHITE_EX + str(data['guild'].get('premium_subscription_count', 'None')))
                print("")
                print(colorama.Fore.YELLOW + f" Guild ID: " + colorama.Fore.LIGHTWHITE_EX + str(data['guild']['id']))
                print(colorama.Fore.YELLOW + f" Guild Name: " + colorama.Fore.LIGHTWHITE_EX + str(data['guild']['name']))
                print(colorama.Fore.YELLOW + f" Guild Description: " + colorama.Fore.LIGHTWHITE_EX + str(data['guild'].get('description', 'None')))
                print("")
